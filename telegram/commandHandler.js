...
bot.onText(/\/start/, async (data) => {
    ...
    if (userStatus === false) {
        welcomeText =
            "Welcome to our Health Monitoring Telegram bot! We're excited to have you on board. Our bot is designed to help you track and monitor your health metrics, such as SpO2, heart rate, body temprature, and more. With our easy-to-use interface and powerful features, you'll be able to stay on top of your health and make informed decisions about your wellness.\nThe first step to achieving your best health goals is to create an account. Creating an account is quick and easy. Simply tap \"Create Profil\" button";
        options = {
            reply_markup: {
                inline_keyboard: [
                    [
